...
wardens create_asset INV-001 "ABC Traders" "RetailMart Ltd" 1000 1783728000 "$(evhash '{"amount":1000,"asset_id":"INV-001","debtor":"RetailMart Ltd","issuer":"ABC Traders"}')"
wardens create_asset INV-002-DUPLICATE "ABC Traders" "RetailMart Ltd" 1000 1783728000 "$(evhash '{"amount":1000,"asset_id":"INV-002-DUPLICATE","debtor":"RetailMart Ltd","issuer":"ABC Traders"}')"
